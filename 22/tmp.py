class Cube:
    ...
    def print_cube(self):
        print("CUBE", self.x_int, self.y_int, self.z_int, self.type)
 
    def volume(self):
 
        volume = (abs(self.x_int[1] - self.x_int[0]) + 1) * (abs(self.y_int[1] - self.y_int[0]) + 1) * (abs(self.z_int[1] - self.z_int[0]) + 1)
        return volume
